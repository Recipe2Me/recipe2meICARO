...
//         // Se busca la interfaz del recurso en el repositorio de interfaces 
		ItfUsoComunicacionWeb recComunicacionChat = (ItfUsoComunicacionWeb) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ.obtenerInterfaz(
						NombresPredefinidos.ITF_USO + identRecursoComunicacionChat);          
                if (recComunicacionChat!=null){
                    recComunicacionChat.enviarMensageAlUsuario(VocabularioGestionCitas.SaludoInicial1,"sga.vmp");
                }
                else {
