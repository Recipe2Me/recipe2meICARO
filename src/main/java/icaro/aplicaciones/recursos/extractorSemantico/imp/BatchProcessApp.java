...
//    File file1 = new File("C:\\GATE_Developer_8.0");
    ...
    File gappFile = new File("C:\\PruebaChatters\\anniePruebaEjemplo1");
    Gate.setGateHome(file1);
    String[] paramsProcessor = new String[3];
    paramsProcessor[0]="-g";
    paramsProcessor[1]="C:\\PruebaChatters\\anniePruebaEjemplo1";
    paramsProcessor[2]="C:\\PruebaChatters\\especCitas1";
